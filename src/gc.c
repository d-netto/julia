...
void jl_init_thread_heap(jl_ptls_t ptls)
{
    ...
    array->pc_start = (void **)malloc_s(GC_QUEUE_INIT_SIZE * sizeof(void *));
    array->data_start =
        (jl_gc_mark_data_t *)malloc_s(GC_QUEUE_INIT_SIZE * sizeof(jl_gc_mark_data_t));
    array->size = GC_QUEUE_INIT_SIZE;
