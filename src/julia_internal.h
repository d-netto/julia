...
typedef enum {
    GC_CLEAN = 0x0, // freshly allocated
    GC_MARKED = 0x1, // reachable and young
    GC_OLD = 0x2, // if it is reachable it will be marked as old
    GC_OLD_MARKED = (GC_OLD | GC_MARKED) // reachable and old
} jl_gc_markbits_t;
